namespace Core.Models
{
    ...
    /// <summary>
    /// Represents the overall outcome of an API call.
    /// </summary>
    ...
    public class ApiResponse<T>
    {
        ...
        /// </summary>
        public ResponseCodeStatus? ResponseCode { get; set; }
        /// <summary>
        ...
        public ApiResponse(ApiResponseStatus status, int statusCode, ResponseCodeStatus responseCode, string? successMessage = null, string? errorMessage = null, string? errorCode = null, string? txn = null, T? returnValue = default)
        {
            Status = status;
